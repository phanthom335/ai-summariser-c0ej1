    ...
    Ai Summariser C0ej1
    ===================
    Command-line assistant leveraging transformer models to tag content efficiently.
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Command-line assistant leveraging transformer models to tag content efficiently.")
